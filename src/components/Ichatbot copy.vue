    ...
    <div class="container">
      ...
      <div class="msg-header">
        <div class="container1">
          <img src="@/assets/user1.png" class="msgimg" />
          <div class="active">
            <p>User name</p>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      sendMessage() {
        ...
        this.addMessage(this.userInput, 'outgoing-chats');
        this.userInput = '';
        ...
        setTimeout(() => {
          ...
          this.addMessage('This is a bot response.', 'received-chats');
        }, 2000);
      },
      addMessage(text, className) {
        ...
        msgDiv.innerHTML = `
          <div class="${className}-img">
            <img src="${className === 'outgoing-chats' ? require('@/assets/user1.png') : require('@/assets/user2.ico')}" />
          </div>
          <div class="${className === 'outgoing-chats' ? 'outgoing-msg' : 'received-msg'}">
            <div class="${className}-msg">
              <p>${text}</p>
              <span class="time">${new Date().toLocaleTimeString()} | ${new Date().toLocaleDateString()}</span>
            </div>
          </div>
        `;
        msgPage.appendChild(msgDiv);
